...
<?php include 'header.php' ?>
    ...
    <?php } // end if ?> 
      <form class="form-signin" method="post" action="">
        ...
        <input type="password" id="inputPassword" name="password" value="<?php echo htmlspecialchars($password); ?>" class="form-control" placeholder="Password" required="Please enter a password">
        <div class="form-check form-check-inline">
            <label class="form-check-label">
              <input class="form-check-input" type="radio" name="user" id="inlineRadio1" value="<?php echo htmlspecialchars($teacher); ?>">Teacher
            </label>
          </div>
          <div class="form-check form-check-inline">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" name="user" id="inlineRadio2" value="<?php echo htmlspecialchars($student); ?>" checked="checked"> Student
            </label>
          </div>
        <input type="hidden" name="action" value="login_valadation">
